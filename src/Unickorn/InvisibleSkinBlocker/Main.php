...
class Main extends PluginBase implements Listener
{
    ...
    public function onEnable() : void {
        ...
        $this->message = $c->get("message", "No intentes entrar con skins invibles ya que se te a detectado.");
    ...
    private function loadSkin(string $geometry, string $texture) : ?Skin {
        ...
        if ($texture !== "") {
            ...
            imagedestroy($image);
            return new Skin(UUID::fromRandom(), $bytes, "", $geometry, $geometryData);
        }
    ...
    public function randomSkin() : ?Skin {
        ...
        return new Skin(UUID::fromRandom(), $bytes, "", "geometry.humanoid.custom", "");
    }
